...
public class DcTracker extends Handler {
   ...
   /*ALPS01555724: The implementation of PriorityQueue is incorrect, use arraylist to sort priority.
    ...
    protected ArrayList<Integer> mSuspendId = new ArrayList <Integer> ();
    ...
    protected static final boolean MTK_OP129_IA_SUPPORT =
            SystemProperties.get("gsm.ril.sim.op129").equals("1") ? true : false;
    protected static final boolean NEED_TO_RESUME_MODEM =
            SystemProperties.get("gsm.ril.data.op.suspendmd").equals("1") ? true : false;
    protected static final boolean MTK_OP17_IA_SUPPORT =
            SystemProperties.get("persist.operator.optr").equals("op17") ? true : false;
    ...
    */
    ...
    boolean isPermanentFail(DcFailCause dcFailCause) {
        ...
        return (dcFailCause.isPermanentFail() &&
                isPermanentFailByOp(dcFailCause, DcFailCauseManager.Operator.OP19) &&
                (mAttached.get() == false || dcFailCause != DcFailCause.SIGNAL_LOST));
    }
    ...
    private void setInitialAttachApn() {
        ...
        if (mInitialAttachApnSetting == null) {
            ...
            mPhone.mCi.setInitialAttachApn(iaApn, mInitialAttachApnSetting.protocol,
...
*/
    ...
    */
    ...
    private void handleSetResume() {
        ...
        mPhone.mCi.setResumeRegistration(mSuspendId.get(mPhone.getPhoneId()), null);
    }
    ...
    private void handleRegistrationSuspend(AsyncResult ar) {
        if (ar.exception == null && ar.result != null) {
            ...
            mSuspendId.add(mPhone.getPhoneId(), ((int[]) ar.result)[0]);
            log("handleRegistrationSuspend: suspending with Id=" +
                mSuspendId.get(mPhone.getPhoneId()));
            synchronized (mNeedsResumeModemLock) {
    ...
    public boolean checkIfDomesticInitialAttachApn(String currentMcc) {
        ...
        } else if (MTK_OP129_IA_SUPPORT && isMccDomestic) {
            return mRegion == REGION_DOMESTIC;
        }

        if (DBG) {
            log("checkIfDomesticInitialAttachApn: Not OP17/OP129 or MCC is not in domestic");
        }
        return true;
    }
    // M: OP17 IA End
    ...
    private boolean isPermanentFailByOp(DcFailCause dcFailCause, DcFailCauseManager.Operator op) {
        ...
        if (mDcFcMgr == null) {
            ...
            isPermanent = mDcFcMgr.isPermanentFailByOp(dcFailCause, op);
        }
        return isPermanent;
    }
