...
public interface CommandsInterface {
   ...
   /**
    ...
    /**
     * Tells the modem if speech codec info for 2/3 HD voice URC is enabled or not.
     *
     * @param enable
    ...
    /**
     * used to register to for Vzw ECC/hVoLTE redial call state change.
     *
     * msg.obj is an AsyncResult
     */
    ...
    */
    ...
    void queryUPBAvailable(int eftype, int fileIndex, Message response);
    void readUPBEmailEntry(int adnIndex, int fileIndex, Message response);
    void readUPBSneEntry(int adnIndex, int fileIndex, Message response);
    void readUPBAnrEntry(int adnIndex, int fileIndex, Message response);
    void readUPBAasList(int startIndex, int endIndex, Message response);
  ...
  /**
    ...
    */
     ...
     */
// TODO: comment out for build pass. module need to check.
//  public void setSrvccCallContextTransfer(int numberOfCall, SrvccCallContext[] callList);
     ...
     * @param obj User object.
     */
    void registerForNetworkEvent(Handler h, int what, Object obj);

    /**
     * Unregister for network event.
     * @param h Handler for notification message.
     */
    void unregisterForNetworkEvent(Handler h);
     ...
     * @param response the responding message.
     */
    void setSimPower(int mode, Message response);
