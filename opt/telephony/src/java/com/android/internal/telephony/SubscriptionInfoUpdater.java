...
public class SubscriptionInfoUpdater extends Handler {
    ...
    private void handleSimLoaded(int slotId) {
        ...
        if (SubscriptionManager.isValidSubscriptionId(subId)) {
            ...
            if (storedSubId != subId) {
                ...
                Rlog.d(LOG_TAG, "check persist.radio.lte.chip : " +
                ...
                if (SystemProperties.get("persist.radio.lte.chip").equals("2")) {
                    if (networkType == RILConstants.NETWORK_MODE_LTE_CDMA_EVDO
                            ...
                            || networkType == RILConstants.NETWORK_MODE_LTE_GSM
                            || networkType == RILConstants.NETWORK_MODE_LTE_TDD_ONLY) {
            ...
            if (subCtrl != null) {
                if (!subCtrl.isReady()) {
                    if (SubscriptionInfoUpdater.sSubInfoUpdater != null) {
                        SystemClock.sleep(100);
                        sSubInfoUpdater.sendMessage(obtainMessage(EVENT_SIM_LOADED, slotId, -1));
                    } else {
    ...
    synchronized private void updateSubscriptionInfoByIccId() {
        ...
        // MTK-END
            ...
            // MTK-START
            // Comment and just clear changed subinfo.
            // mSubscriptionManager.clearSubscriptionInfo();
            ...
            for (int i = 0; i < PROJECT_SIM_NUM; i++) {
                ...
                List<SubscriptionInfo> oldSubInfo =
                        SubscriptionController.getInstance().getSubInfoUsingSlotIdWithCheck(i,
            ...
            if (nNewCardCount == 0) {
                ...
                intent = setUpdatedData(SubscriptionManager.EXTRA_VALUE_NEW_SIM, nSubCount,
                        nNewSimStatus);
            }
            // MTK-END
            ...
            // MTK-START
                ...
                // RADIO_UNAVAILABLEon our platform. Radio module will do capability switch after
