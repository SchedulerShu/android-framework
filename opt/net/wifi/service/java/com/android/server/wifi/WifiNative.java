...
public class WifiNative {
    ...
    public int addNetwork() {
        ...
        if (mInterfaceName.equals("p2p0")) {
            return doIntCommand("IFNAME=" + mInterfaceName + " " + "ADD_NETWORK");
        }
    ...
    private native boolean setNetworkVariableCommand(String iface, int netId, String name,
            String value);
