...
public class ImsCallSession {
    ...
    private class IImsCallSessionListenerProxy extends IImsCallSessionListener.Stub {
        ...
        /// M: MTK added functions @{
        public void callSessionTransferred(IImsCallSession session) {
            if (mListener != null) {
                mListener.callSessionTransferred(ImsCallSession.this);
            }
        }

        public void callSessionTransferFailed(IImsCallSession session, ImsReasonInfo reasonInfo) {
            if (mListener != null) {
     ...
     *
     * @see Listener#callSessionEctFailed
     */
