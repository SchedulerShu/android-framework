    ...
    public void start(ImsCallSession session, String callee)
        ...
        synchronized(mLockObj) {
            ...
            try {
                ...
                mAddress = callee;
                /// @}
                /// M: ALPS02871840, keep the mAddress for OI as default. @{
                mCallProfile.setCallExtra(ImsCallProfile.EXTRA_OI, mAddress);
                /// @}
            } catch (Throwable t) {
                loge("start(1) :: ", t);
   ...
   /**
    ...
    private class ImsCallSessionListenerProxy extends ImsCallSession.Listener {
        ...
        public void callSessionProgressing(ImsCallSession session, ImsStreamMediaProfile profile) {
            ...
            synchronized(ImsCall.this) {
                ...
                /// M: ALPS02944847. ImsCall might be closed if the SRVCC complete quickly.
                /// It will set mCallProfile to null. Null check before use. @{
                if (mCallProfile != null) {
                    mCallProfile.mMediaProfile.copyFrom(profile);
                }
                /// @}
	 ...
	 * Conference Scenarios :
        ...
        public void callSessionMergeComplete(ImsCallSession newSession) {
            ...
            if (!isMergeHost()) {
                /// M: ALPS02502328, while merging 1A1H, user answer the incomming call,
